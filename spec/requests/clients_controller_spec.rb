    ...
    context 'when user is logged in' do
      ...
      context 'when user is a tenant' do
        ...
        before do
          ...
          post '/clients', params: { client: client_params, address: address_params, user: user_data }, headers: { 'Authorization': "Bearer #{token}" }
        end
      ...
      context 'when user is an admin' do
        ...
        it 'returns a forbidden response' do
          post '/clients', headers: { 'Authorization': "Bearer #{token}" }
  ...
  describe 'PUT #update' do
    ...
    context 'when user is logged in' do
      ...
      context 'when user is a tenant' do
        ...
        before do
          put "/clients/#{client.id}", params: { client: client_params, address: address_params, user: user_data }, headers: { 'Authorization': "Bearer #{token}" }
        end
      ...
      context 'when user is an admin' do
        ...
        it 'returns a forbidden response' do
          put "/clients/#{client.id}", headers: { 'Authorization': "Bearer #{token}" }
