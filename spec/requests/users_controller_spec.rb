    ...
    context 'when user is logged in' do
      ...
      context 'when user is a tenant' do
        ...
        context 'when the user updates it' do
          ...
          before do
            put "/users/#{user.id}", params: { user: user_params }, headers: { 'Authorization': "Bearer #{token}" }
          end
        ...
        context 'when tenant tries to update another user' do
          ...
          it 'returns a forbidden response' do
            put "/users/#{another_user.id}", headers: { 'Authorization': "Bearer #{token}" }
      ...
      context 'when user is an admin' do
        ...
        context 'when tenant tries to update another user' do
          ...
          before do
            put "/users/#{update_user.id}", params: { user: user_params }, headers: { 'Authorization': "Bearer #{token}" }
          end
      ...
      context 'when user logged is admin' do
        ...
        context 'when user is found' do
          ...
          context 'when the user sought is a tenant' do
            ...
            before do
              get "/users/#{tenant_user.id}", headers: { 'Authorization': "Bearer #{token}" }
            end
          ...
          context 'when the user sought is a affiliate' do
            ...
            before do
              get "/users/#{affiliate.user.id}", headers: { 'Authorization': "Bearer #{token}" }
            end
          ...
          context 'when the user sought is a employee' do
            ...
            before do
              get "/users/#{employee_user.id}", headers: { 'Authorization': "Bearer #{token}" }
            end
          ...
          context 'when the user sought is a client' do
            ...
            before do
              get "/users/#{client_user.id}", headers: { 'Authorization': "Bearer #{token}" }
            end
      ...
      context 'when user logged is tenant' do
        ...
        context 'when user is found' do
          ...
          context 'when the user sought is a affiliate' do
            ...
            before do
              get "/users/#{affiliate_user.id}", headers: { 'Authorization': "Bearer #{token}" }
            end
  ...
  describe 'PUT activate' do
    context 'when user activation is successful' do
      ...
      before do
        ...
        put "/users/#{inactive_user.id}/activate", params: activate_params
      end
    ...
    context 'when user is found' do
      ...
      context 'when validation is found' do
        before do
          ...
          post "/users/password_recovery", params: password_recovery_params
        end
  ...
  describe 'PUT update_password' do
    context 'when validation is found' do
      ...
      before do
        ...
        put "/users/#{user.id}/update_password", params: update_password_params
      end
