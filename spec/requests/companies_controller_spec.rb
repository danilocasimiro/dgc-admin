  ...
  describe 'POST #create' do
    context 'when user is logged in' do
      ...
      context 'when user is a tenant' do
        ...
        before do
          post '/companies', params: { company: company_params, address: address_params }, headers: { 'Authorization': "Bearer #{token}" }
        end
      ...
      context 'when user is a employee' do
        ...
        it 'returns a forbidden response' do
          post '/companies', headers: { 'Authorization': "Bearer #{token}" }
    ...
    context 'when user is logged in' do
      ...
      context 'when user is a tenant' do
        ...
        before do
          ...
          put "/companies/#{company.id}", params: { company: company_params, address: address_params}, headers: { 'Authorization': "Bearer #{token}" }
        end
      ...
      context 'when user is an admin' do
        ...
        it 'returns a forbidden response' do
          put "/companies/#{company.id}", headers: { 'Authorization': "Bearer #{token}" }
