  ...
  describe 'POST #create' do
    context 'when user is logged in' do
      ...
      context 'when user is a tenant' do
        ...
        before do
          post '/products', params: { product: product_params.merge(product_type_id: product_type.id) }, headers: { 'Authorization': "Bearer #{token}" }
        end
      ...
      context 'when user is an admin' do
        ...
        it 'returns a forbidden response' do
          post '/products', headers: { 'Authorization': "Bearer #{token}" }
  ...
  describe 'PUT #update' do
    ...
    context 'when user is logged in' do
      ...
      context 'when user is a tenant' do
        ...
        before do
          put "/products/#{product.id}", params: { product: product_params }, headers: { 'Authorization': "Bearer #{token}" }
        end
      ...
      context 'when user is an admin' do
        ...
        it 'returns a forbidden response' do
          put "/products/#{product.id}", headers: { 'Authorization': "Bearer #{token}" }
