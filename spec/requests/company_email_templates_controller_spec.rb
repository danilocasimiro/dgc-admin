...
RSpec.describe 'CompanyEmailTemplateController', type: :request do
        ...
        context 'when user is a tenant' do
          ...
          context 'when company email template belongs to logged company' do
            before do
              ...
              get "/company_email_templates", headers: { 'Authorization': "Bearer #{token}" }
            end
  ...
  describe 'GET #show' do
    context 'when user is logged in' do
      context 'when company email template is found' do
        ...
        context 'when user is a tenant' do
          ...
          context 'when company email template belongs to logged company' do
            before do
              get "/company_email_templates/#{company_email_template.id}", headers: { 'Authorization': "Bearer #{token}" }
            end
      ...
      context 'when company email template is not found' do
        before do
          get "/company_email_templates/any_invalid_id"
        end
    ...
    context 'when user is not logger in' do
      before do
        get "/company_email_templates/#{company_email_template.id}"
      end
  ...
  describe 'PUT #update' do
    context 'when user is logged in' do
      context 'when user is a tenant' do
        ...
        before do
          ...
          put "/company_email_templates/#{company_email_template.id}", params: { company_email_template: company_email_template_params}, headers: { 'Authorization': "Bearer #{token}" }
        end
      ...
      context 'when user is an admin' do
        ...
        it 'returns a forbidden response' do
          put "/company_email_templates/#{company_email_template.id}", headers: { 'Authorization': "Bearer #{token}" }
    ...
    context 'when user is not logger in' do
      before do
        put "/company_email_templates/#{company_email_template.id}"
      end
