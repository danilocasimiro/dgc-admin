...
RSpec.describe 'EmployeesController', type: :request do
  let(:token) { JwtToken.generate_token(user, company_id) }
    ...
    context 'when user is logged in' do
      ...
      context 'when user is a tenant' do
        ...
        before do
          ...
          post '/employees', params: { employee: employee_params, user: user_data }, headers: { 'Authorization': "Bearer #{token}" }
        end
      ...
      context 'when user is a employee' do
        ...
        it 'returns a forbidden response' do
          post '/employees', headers: { 'Authorization': "Bearer #{token}" }
    ...
    context 'when user is logged in' do
      ...
      context 'when user is a tenant' do
        context 'when companies_params is not send' do
          ...
          before do
            put "/employees/#{employee.id}", params: { employee: employee_params }, headers: { 'Authorization': "Bearer #{token}" }
          end
        ...
        context 'when companies_params is send' do
          ...
          before do
            ...
            put "/employees/#{employee.id}", params: { employee: employee_params, companies: companies_params }, headers: { 'Authorization': "Bearer #{token}" }
          end
      ...
      context 'when user is a employee' do
        context 'when employee updated is logged' do
          ...
          before do
            put "/employees/#{user.profile.id}", params: { employee: employee_params }, headers: { 'Authorization': "Bearer #{token}" }
          end
        ...
        context 'when employee logged try to updated another employee' do
          ...
          it 'returns a forbidden response' do
            put "/employees/#{employee.id}", headers: { 'Authorization': "Bearer #{token}" }
